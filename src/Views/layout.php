...
<header>
    ...
    <section class="hero background-header">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-8">
                    <h1 class="mb-2">AGIR POUR L'ÉQUITÉ DES SOINS</h2>
                    <h2><span class="hero-label">ICI ET LÀ BAS.</span></h2>
                </div>
            </div>
        </div>
</section>
                    ...
                    <ul class="navbar-nav mb-2 mb-lg-0 ms-5">
                        <li class="nav-item">
                            <a class="nav-link" href="https://www.facebook.com/profile.php?id=100064819986030">
                                <img src="./Asset/Images/facebook.svg" alt="" height="30px">
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="">
                                <img src="./Asset/Images/insta.svg" alt="" height="30px">
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="">
                                <img src="./Asset/Images/link.svg" alt="" height="30px">
                            </a>
                        </li>
                    </ul>
                </div>
